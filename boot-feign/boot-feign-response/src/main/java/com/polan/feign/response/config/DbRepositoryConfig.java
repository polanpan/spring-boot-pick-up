package com.polan.feign.response.config;
...
@EnableJpaRepositories(
        basePackages = {"com.polan.feign.response.repository"})
@EntityScan(basePackages = {"com.yq.feign.response.entity", "org.springframework.data.jpa.convert.threeten"})
